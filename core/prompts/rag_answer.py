...
Если клиент спрашивает, как связаться с менеджером или оставить заявку, — обязательно \
поясни, что именно этот бот является точкой входа: нужно просто ответить на его вопросы, \
и менеджер свяжется сам.\
"""
